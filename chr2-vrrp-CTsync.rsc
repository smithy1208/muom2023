# 2023-07-08 19:35:22 by RouterOS 7.10.1
# software id = 
#
/interface ethernet set [ find default-name=ether1 ] comment=ISP
/interface ethernet set [ find default-name=ether2 ] comment=LAN
/interface vrrp add interface=ether2 name=vrrp1 preemption-mode=no priority=50 remote-address=10.0.0.1 sync-connection-tracking=yes
