# 2023-07-20 05:50:46 by RouterOS 7.10.1
# software id = 
#
...
/ip address add address=10.0.10.254/24 interface=vlan10 network=10.0.10.0
/ip address add address=10.0.20.254/24 interface=vlan20 network=10.0.20.0
/ip address add address=10.0.30.254/24 interface=vlan30 network=10.0.30.0
/ip address add address=10.0.40.254/24 interface=vlan40 network=10.0.40.0
