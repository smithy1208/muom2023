# 2023-07-08 20:09:21 by RouterOS 7.10.1
# software id = 
#
...
/interface vlan add interface=ether2 name=vlan30 vlan-id=30
/interface vlan add interface=ether2 name=vlan40 vlan-id=40
/interface vrrp add group-authority=vrrp1 interface=vlan10 name=vrrp10 preemption-mode=no
/interface vrrp add group-authority=vrrp1 interface=vlan20 name=vrrp20 preemption-mode=no
/interface vrrp add group-authority=vrrp1 interface=vlan30 name=vrrp30 preemption-mode=no
/interface vrrp add group-authority=vrrp1 interface=vlan40 name=vrrp40 preemption-mode=no
...
/ip address add address=10.0.10.254 interface=vrrp10 network=10.0.10.254
/ip address add address=10.0.20.254 interface=vrrp20 network=10.0.20.254
/ip address add address=10.0.30.254 interface=vrrp30 network=10.0.30.254
/ip address add address=10.0.40.254 interface=vrrp40 network=10.0.40.254
