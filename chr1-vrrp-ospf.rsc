# 2023-07-08 20:29:04 by RouterOS 7.10.1
# software id = 
#
...
/routing ospf instance add disabled=no name=ospf-instance-1 router-id=10.0.0.1
/routing ospf area add disabled=no instance=ospf-instance-1 name=bb
...
/routing ospf interface-template add area=bb disabled=no interfaces=ether2 networks=10.0.0.0/24
/routing ospf interface-template add area=bb disabled=no interfaces=vlan10,vlan20,vlan30,vlan40 networks=10.0.0.0/18 passive
